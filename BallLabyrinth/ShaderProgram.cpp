...
ShaderProgram::ShaderProgram(const std::string& name, const Shader& vertex, const Shader& fragment)
: name(name)
{
    shaderProgramId = glCreateProgram();
    attachShader(vertex);
...
void
ShaderProgram::vertexAttribPointer(const std::string& attribName,
                                   GLint              size,
                                   GLenum             type,
                                   GLsizei            stride,
                                   const GLvoid*      data,
...
GLuint
ShaderProgram::bufferLocation(const std::string& name) const
{
...
void
ShaderProgram::setBuffer(const std::string& name, GLint v) const
{
...
void
ShaderProgram::setUniform1i(const std::string& name, GLint v) const
{
    glUniform1i(uniformLocation(name), v);
}

void
ShaderProgram::setUniform1f(const std::string& name, GLfloat v) const
{
    glUniform1f(uniformLocation(name), v);
}

void
ShaderProgram::setUniform2f(const std::string& name, GLfloat v0, GLfloat v1) const
{
    glUniform2f(uniformLocation(name), v0, v1);
}

void
ShaderProgram::setUniform2f(const std::string& name, glm::vec2 v) const
{
    glUniform2f(uniformLocation(name), v.x, v.y);
}

void
ShaderProgram::setUniform3f(const std::string& name, GLfloat v0, GLfloat v1, GLfloat v2) const
{
    glUniform3f(uniformLocation(name), v0, v1, v2);
}

void
ShaderProgram::setUniform3f(const std::string& name, glm::vec3 v) const
{
...
ShaderProgram::setUniform4f(
    const std::string& name, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) const
{
    glUniform3f(uniformLocation(name), v0, v1, v2);
}

void
ShaderProgram::setUniform4f(const std::string& name, glm::vec4 v) const
{
    glUniform4f(uniformLocation(name), v.x, v.y, v.z, v.w);
}

void
ShaderProgram::setMatrixUniform4f(const std::string& name, glm::mat4 m) const
{
    glUniformMatrix4fv(uniformLocation(name), 1, GL_FALSE, glm::value_ptr(m));
}

void
ShaderProgram::setMatrixUniform3f(const std::string& name, glm::mat3 m) const
{
